...
//most of this part is the test database used which isnt on github
...
//    private static String enternormal="INSERT INTO sightings(location,creation,ranger_id,animal_id,location_name,animal_name) VALUES(?,?,?,?,?,?)";
...
//
//        Sightings sightings=new Sightings(1,1,1,"Grasslands","Leopard");
//
//        try {
//            conn = DriverManager.getConnection(url, user, password);
//            PreparedStatement stmt = conn.prepareStatement(enternormal);
//
//            stmt.setInt(1,sightings.getLocation());
//            stmt.setDate(2,sightings.getCreation());
//            stmt.setInt(3,sightings.getRanger_id());
//            stmt.setInt(4,sightings.getAnimal_id());
//            stmt.setString(5,sightings.getLocation_name());
//            stmt.setString(6,sightings.getNormalanimalname());
//
//            stmt.executeUpdate();
//
